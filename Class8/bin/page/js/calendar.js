...
$(function () {
  ...
  $('#calendar').calendar({
	...
	//点击选中日期
	$("#calendar-date li").click(function(){
		//alert($(this).html());//当日
		//alert($(this).attr("data"));//当天日期
		showClassList($(this).attr("data"));
...
;(function ($, window, document, undefined) {
  ...
  Calendar.prototype = {
    ...
    renderDOM: function () { // 渲染DOM
      ...
      this.$calendar_date = $('<ul class="calendar-date" id="calendar-date"></ul>');
    ...
    inital: function () { // 初始化
      ...
      if (this.opts.backToday) {
        this.$backToday.bind('click', function () {
        	//T方法
        	 	$("#calendar-date li").removeClass("navClicked");
