...
VIProductVersion "1.0.0.1142"
VIAddVersionKey /LANG=${LANG_SIMPCHINESE} "FileDescription" "BMClass Client"
VIAddVersionKey /LANG=${LANG_SIMPCHINESE} "FileVersion" "1.0.0.1142"
VIAddVersionKey /LANG=${LANG_SIMPCHINESE} "ProductName" "BMClass Client Install Program"
VIAddVersionKey /LANG=${LANG_SIMPCHINESE} "ProductVersion" "1.0.0.1142"
