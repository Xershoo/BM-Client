...
namespace ELEMENT{
	QDomElement firstChildElement(const QDomElement &element,const QString &tagName = QString()){
		return element.firstChildElement(tagName);
	}
	QDomElement nextSiblingElement(const QDomElement &element,const QString &tagName = QString()){
...
bool CXMLFile::firstChildElement()
{
	...
	if(ELEMENT::nextElement(ELEMENT::firstChildElement,m_element))
	{
		return true;
	}
	return false;
...
bool CXMLFile::firstChildElement(const QString &tagName)
{
	...
	if(ELEMENT::nextElement(ELEMENT::firstChildElement,m_element,tagName))
	{
		return true;
	}
	return false;
...
bool CXMLFile::nextSiblingElement()
{
	...
	if(ELEMENT::nextElement(ELEMENT::nextSiblingElement,m_element))
	{
		return true;
	}
	return false;
...
bool CXMLFile::nextSiblingElement(const QString &tagName)
{
	...
	if(ELEMENT::nextElement(ELEMENT::nextSiblingElement,m_element,tagName))
	{
		return true;
	}
	return false;
