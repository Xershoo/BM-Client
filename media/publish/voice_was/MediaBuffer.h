...
class CAecMediaBuffer : public IMediaBuffer
{
private:
	DWORD        m_cbLength;
	...
	CAecMediaBuffer(DWORD cbMaxLength, HRESULT& hr) :
	m_nRefCount(1),
...
public:
	...
	static HRESULT Create(long cbMaxLen, IMediaBuffer **ppBuffer)
	{
		...
		pBuffer = new CAecMediaBuffer(cbMaxLen, hr);
