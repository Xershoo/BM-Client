...
/*
	fz_open_document: Open a PDF document.
...
fz_document *fz_open_document_w(fz_context *ctx, wchar_t *filename);
fz_document *fz_open_document_with_data(fz_context *ctx, unsigned char* data,int len);
