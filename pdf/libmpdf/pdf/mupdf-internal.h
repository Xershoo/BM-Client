...
pdf_document *pdf_open_document_no_run_w(fz_context *ctx, const wchar_t *filename);
...
pdf_document *pdf_open_document_no_run_with_data(fz_context *ctx, unsigned char *data,int len);
